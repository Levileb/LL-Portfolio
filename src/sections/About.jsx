...
import profileLight from "../assets/images/profile/LL2.png";
import profileDark from "../assets/images/profile/LL1.png";
      ...
      <Container>
        ...
        <div className="grid gap-12 lg:grid-cols-[360px_1fr] lg:gap-20">
          ...
          <div>
            ...
            {/* Profile Image */}
            <div className="mt-8 overflow-hidden rounded-xl border border-gray-200 bg-white/40 dark:border-white/10 dark:bg-white/5">

              {/* Light Mode */}
              <img
                src={profileLight}
                alt="Levi John Ledesma"
